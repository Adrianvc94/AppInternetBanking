...
namespace API.Controllers
{
    ...
    public class MarchamosController : ApiController
    {
        ...
        public IHttpActionResult PutMarchamo(Marchamo marchamo)
        {
            ...
            {
                if (!MarchamoExists(marchamo.CodMarchamo))
                {
                    return NotFound();
                }
                else
        ...
        public IHttpActionResult PostMarchamo(Marchamo marchamo)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = marchamo.CodMarchamo }, marchamo);
        }
        ...
        {
            return db.Marchamo.Count(e => e.CodMarchamo == id) > 0;
        }
    }
}