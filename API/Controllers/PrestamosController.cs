...
namespace API.Controllers
{
    ...
    public class PrestamosController : ApiController
    {
        ...
        // GET: api/Prestamos
        public IQueryable<Prestamo> GetServicio()
        {
            return db.Prestamo;
        }
        ...
        public IHttpActionResult PostPrestamo(Prestamo prestamo)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = prestamo.CodPrestamo }, prestamo);
        }
        ...
        {
            return db.Prestamo.Count(e => e.CodPrestamo == id) > 0;
        }
    }
}
