...
namespace AppWebInternetBanking.Controllers
{
    public class TarjetaManager
    {
        ...
        public async Task<Tarjeta> ObtenerTarjeta(string token, string codigo)
        {
        ...
        public async Task<IEnumerable<Tarjeta>> ObtenerTarjeta(string token)
        {
            HttpClient httpClient = GetClient(token);
        ...
        public async Task<Tarjeta> Eliminar(string codigo, string token)
        {
            HttpClient httpClient = GetClient(token);
