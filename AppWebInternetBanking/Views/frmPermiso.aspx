...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gvPermisos" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        <Columns>
             <asp:BoundField HeaderText="Codigo" DataField="CodPermiso" />
            <asp:BoundField HeaderText="ID Usuario" DataField="CodUsuario" />
            <asp:BoundField HeaderText="Tipo Permiso" DataField="TipoPermiso" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td><asp:Literal ID="ltrTipoPermiso" Text="Licencia" runat="server" /></td>
                            <td><asp:TextBox ID="txtTipoPermiso" runat="server" Enabled="true" CssClass="form-control" /></td>
                        </tr>
                        <tr>
